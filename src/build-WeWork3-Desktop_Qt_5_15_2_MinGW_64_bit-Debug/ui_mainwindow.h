...
"}"));
        ...
        log_button->setGeometry(QRect(520, 370, 191, 31));
        QFont font2;
...
""));
        ...
        minus_buton->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
        QIcon icon;
        ...
        quit_button->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);"));
        QIcon icon1;
        ...
        hint_1 = new QLabel(centralwidget);
        hint_1->setObjectName(QString::fromUtf8("hint_1"));
        hint_1->setGeometry(QRect(560, 330, 111, 16));
        hint_1->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));
